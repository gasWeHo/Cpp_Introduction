...
Es kann vom �bersetzer nicht sicher gestellt werden, dass auf diese Weise
...
Ein Konstruktor kann optional �ber eine so genannte *Element-Initialisierungsliste* verf�gen,
die die Instanzvariablen initialisiert,
bevor der Rumpf des Konstruks ausgef�hrt wird.
...
gewisserma�en dem *Quelldatentyp*  entspricht.
